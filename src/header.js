...
function Header() {
  ...
  return (
    <>
    <div className="px-xl-5 px-lg-4 px-md-3 w-100">
    <header >
        <nav className="navbar navbar-expand-lg navbar-light">
          <div className="d-xl-flex d-lg-flex">
            ...
            <div className="collapse navbar-collapse" id="navbarNav">
              <ul className="head-ul navbar-nav ms-auto">
      ...
      <div className="container mt-5">
        ...
        <div className="position-relative py-80">
          <div className="row">
            ...
            <div className="col-7 mb-4 position-absolute img2-banner">
        ...
        <p>
          ...
          asperiores alias similique ducimus quasi quidem atque neque! Et
          necessitatibus quidem animi laboriosam, quasi sed libero consequatur
          neque maxime excepturi?
        </p>
      </div>
